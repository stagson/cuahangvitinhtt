                    ...
                    foreach ($arrSanPham as $sp) {
                        ...
                        if ($dmsp != null) {
                            if ($dmsp['madmspcha'] == "3") { //
                                ...
                                echo '          <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="../controller/xulygiohang.php?masanpham=SP01">Thêm giỏ hàng</a>';
                                echo '      </div>';
                                echo '  </div>';
                                echo '</div>';
                            }
