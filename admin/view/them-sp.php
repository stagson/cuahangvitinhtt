                        ...
                        <div class="card card-small mb-4">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item p-3">
                                    <div class="row">
                                        <div class="col">
                                            <form action="../controller/xuly-sp.php" method="post" enctype="multipart/form-data">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="feTenSP">Tên sản phẩm</label>
                                                        <input type="text" class="form-control" name="txtTenSanPham" id="feTenSP" placeholder="Tên sản phẩm" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input name="numSoLuong" type="number" class="form-control" id="feSoLuong" value="0" min="1" max="999999999" placeholder="Cái" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input name="numGia" type="number" class="form-control" id="feGia" min="0" value="0" placeholder="đ" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label for="feGhiChu">Mô tả</label>
                                                        <textarea class="form-control" name="txtMoTa" rows="7" placeholder="Mô tả sản phẩm..."></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row mb-3">
                                                    <div class="form-group col-md-12">
                                                        <label for="feHinhAnh">Hình ảnh</label>
                                                        <input name="fileHinh" type="file" class="form-control" id="feHinhAnh" required>
                                                    </div>
                                                </div>
                                                <div style="text-align:right;">
                                                    <a value="them" href="" class="btn btn-mb-2 btn btn-secondary mr-2 btn-font"><i class="fas fa-undo"></i> Nhập lại</a>
                                                    <button name="btnThem" value="them" type="submit" class="btn btn-mb-2 btn btn-success mr-2 btn-font" style="margin:0 !important;"><i class="fas fa-plus"></i> Thêm</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
