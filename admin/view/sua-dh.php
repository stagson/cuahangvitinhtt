                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="page-header row no-gutters py-4">
                        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                            ...
                            <h3 class="page-title">Sửa thông tin Đơn Hàng</h3>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    <div class="col-12">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="feHoTen"
                                                            placeholder="Họ và Tên" value="Nguyễn Hoàng Tiến">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="feNgayTaoDon">Ngày tạo đơn</label>
                                                        <input type="date" class="form-control" id="feNgayTaoDon"
                                                            value="2021-11-08">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="feSoDienThoai">Số điện thoại</label>
                                                        <input type="text" class="form-control" id="feSoDienThoai"
                                                            placeholder="Số điện thoại" value="0909000000">
                                                    </div>
                                                </div>
                                                <div class="form-row mb-3">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="feDiaChi"
                                                            placeholder="Địa chỉ" value="180 Cao Lỗ, P4, Q8, Tp HCM">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea style="padding-top:9.5px;padding-bottom:9.5px;"
                                                            ...
                                                            placeholder="Ghi chú...">khách chỉ nhận hàng trong giờ hành chính</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
